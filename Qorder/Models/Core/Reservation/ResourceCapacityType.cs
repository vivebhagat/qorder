...
{
    public class ResourceCapacityType : IActivableEntity, UIEntity<ResourceCapacityType>
    {
        ...
        public object absorb(ResourceCapacityType @object)
        {
            return @object;
        }

        public ResourceCapacityType emit()
        {
            return this;
        }
    }
