...
var config = {
    ...
    api_base: '/api/Filter/',
    onscreenEdit: true,
    template_url: '/Scripts/app/cmp/filter.dialog.html'
};


function filter_dialog(app, config, tag, Id) {
    ...
    app.component(tag, {
        controller: function ($scope, $mdDialog, $sce, $rootScope, $location, $http, defaultService, authService) {
                    ...
                    controller: function ($scope, $mdDialog)
                    {
                        ...
                        $scope.Add = function (m) {
                            ...
                            if (m == null) {
                                ...
                                _apppost($http, { url:api_url + $scope.config.api_base + 'Add', model:m,
                                    ...
                                    eresp:function (response) { $scope.AddDefaultMessage.ErrorMessage = response.data.ErrorMessage; }}
                                );
                            }
                        };
            ...
            $scope.FilterAll = function () {
                ...
                _apppost($http, { url:api_url + $scope.config.api_base + '_postGetFiltered',
                    mode:{ filterFields: $scope._filterFieldList, Id: $scope.Filter.Id},
            ...
            this.$onInit = () => {
                ...
                $scope.defaultService.SetSetupMenu();
